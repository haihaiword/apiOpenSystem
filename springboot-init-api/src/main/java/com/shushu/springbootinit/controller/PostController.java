...
import com.shushu.springbootinit.model.dto.post.PostEditRequest;
...
public class PostController {
     ...
     */
    @PostMapping("/add")
    public BaseResponse<Long> addPost(@RequestBody UserInterfaceInfoAddRequest postAddRequest, HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> updatePost(@RequestBody UserInterfaceInfoUpdateRequest postUpdateRequest) {
